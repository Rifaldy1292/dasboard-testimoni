...
<template>
  ...
  >
    ...
    <div class="grid grid-cols-1 px-7 py-6 gap-5">
      ...
      <!-- only show if select machine -->

      <template v-if="!selectedOneMachine">
        <!-- text red -->
        <div class="flex items-center justify-center">
          <span class="text-xl font-medium text-red-500 dark:text-red-400"
            >Please select machine first</span
          >
        </div>
      </template>
